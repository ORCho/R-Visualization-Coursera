...
fig115%>%ggplot(aes(x=dwnom1,y=all_pass, color=Gender))+
  geom_point()+
...
majority_changed<- recode(fig115$majority,`1`="Majority",`0`="Minority")
fig115 <- add_column(fig115,majority_changed)


fig115%>%ggplot(aes(x=votepct,y=all_pass, color=Gender))+
  geom_point()+
  labs(x="Vote Percentage",y="Bills Passed")+
  scale_color_manual(values=c("orange","green"))+
  facet_wrap(~majority_changed)
...
ggplot(fig115,aes(y=les,group=majority_changed))+
  geom_boxplot()+
