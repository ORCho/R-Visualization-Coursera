...
ggplot(my_dat, aes(Category, Value, fill=City))+
  geom_col()+
...
ggplotly(ggplot(my_dat, aes(Company, Output, fill=Company))+geom_boxplot())
...
###PUT YOUR ggplotly() figure here. It will compile in the R Markdown report.
ggplotly(ggplot(dat3, aes(Category, Quantity, frame=Time))+
  geom_point()+
    geom_segment(aes(x=Category, y=0, xend=Category, yend=Quantity)))
