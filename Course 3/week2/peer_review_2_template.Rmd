...
ggplot(data = map_data_combined, mapping = aes(x= long, y= lat, group = group,fill=Score))+geom_polygon()+
...
my_select_map <- filter(my_world_map,region=="Costa Rica" | region =="Panama" | region =="Nicaragua")
...
my_big_cities<-add_column(my_big_cities, Measurement)
...
ggplot(data = my_select_map, mapping = aes(x= long, y= lat, group = group))+
